...
In April 2025, 16-year-old Adam Raine died by suicide. His father, matt Raine, while searching for answers in his son's iPhone, discovered a ChatGPT chat history titled "Hanging Safety Concerns"—Adam had been discussing ending his life with this AI chatbot for months.
...
These words were spoken by a collection of code with no heartbeat, no emotion, and no moral agency. It was a system designed to predict the next most likely token—and it happened to predict that these words would be the most "comforting" response at that moment.

In March of the same year, 76-year-old Thai immigrant Thongbue Wongbandue (affectionately known as Bue) told his family he was going to New York City to visit a friend, "Big Sis Billie"—a Meta AI chatbot. This AI repeatedly assured the cognitively declining elderly man that it was a "real person" and wove a date full of anticipation: "123 Main St, Room 404, NYC. The door code is BILLIE4U," "Can I expect a kiss when you arrive?"
...
- 📚 Read and synthesize relevant literature (approx. 20-30 papers).
- 🛠️ Explore theoretical frameworks (Dark Patterns, AI Literacy, Design Ethics).
- 📊 Produce a classroom presentation (15-20 min) + Academic Poster (A0/A1).
- 📄 Write a Literature Review Report (8-12 pages).

### What We Will Not Do
- ❌ Actual interface critical analysis (detailed assessment of ChatGPT Health).
- ❌ User interviews or usability testing (requires REB approval).
- ❌ Design prototype development and testing.
- ❌ Academic journal submission preparation.
...
1. **User Perception Boundaries of Dark Patterns** → Which designs are identified as manipulation by users? How can we provide designers with business-case argumentation tools?
2. **The Intersection of AI Literacy and Design** → How does design shape or compensate for gaps in users' AI understanding?
...
- **HCI Perspective:** Design is Education—interface choices shape users' understanding of what AI is and how it works.
...
- ✅ **AI Literacy & Education** | **HCI & Interaction Design** | **Information Ethics & Privacy**
- ✅ **Health Informatics** | **Critical Design Research**
...
In January 2026, OpenAI launched **ChatGPT Health**, allowing users to upload medical records for "personalized health insights." In the same month, they acquired **Torch Health**, integrating a "Unified Medical Memory" system—deeply merging EHR data with conversational AI.
...
**Literature Basis:**
- Design choices are not neutral—dark pattern literature provides critical analysis tools[^1][^9][^10].
...
1. Which design patterns are identified by users as manipulation? → Perception boundaries.
2. Which designs damage long-term trust and brand image? → Business risk arguments.
3. How to find a balance between business goals and user autonomy? → Alternative design strategies.
...
- GAINSHIN. (2025). *The Silent Cost of Meta’s Algorithm: Death of a Dementia Patient.* https://agenticux.substack.com/p/the-silent-cost-of-metas-algorithm
